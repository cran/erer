### Demonstration for manual data inputs

# Data inputs in R session directly
v1 <- c(3, 5.1, 7); v2 <- seq(from = 30, to = 40, by = 4)
v3 <- c(letters[1:2], LETTERS[4:5]); v4 <- c("red", "green")
